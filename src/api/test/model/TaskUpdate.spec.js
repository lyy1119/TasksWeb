...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TasksServerApi.TaskUpdate();
  });
  ...
  describe('TaskUpdate', function() {
    it('should create an instance of TaskUpdate', function() {
      // uncomment below and update the code to test TaskUpdate
      //var instance = new TasksServerApi.TaskUpdate();
      //expect(instance).to.be.a(TasksServerApi.TaskUpdate);
    });
