...
class TaskUpdate {
    ...
    /**
     * Validates the JSON data with respect to <code>TaskUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TaskUpdate</code>.
     */
 ...
 * @member {String} title
 */
TaskUpdate.prototype['title'] = undefined;

/**
 * @member {String} description
 */
TaskUpdate.prototype['description'] = undefined;

/**
 * @member {Boolean} completed
 */
TaskUpdate.prototype['completed'] = undefined;
